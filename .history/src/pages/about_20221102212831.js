      ...
      <div className={styles.root}>
        ...
        <Container size={'large'} spacing={'min'}>
          <div className={styles.detailContainer} ref={historyRef}>
            <p>
              Founded in 2022, Ann & Betty,  two very good long-term friends
who have engaged three local women—Margaret Wairimu, Agnes Njoki and Tabitha Njambi—to hand-
knit baby and toddler clothing.
            </p>
            <br />
            <br />
            <p>
...
materials. We aim to grow our knitters to a community of 15 in the next two years.
            </p>
          </div>
        </Container>
